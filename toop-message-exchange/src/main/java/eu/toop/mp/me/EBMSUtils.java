...
public final class EBMSUtils {
  ...
  /**
   * See http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/profiles/AS4-profile/v1.0/os/AS4-profile-v1.0-os.html#__RefHeading__26454_1909778835
   */
  ...
  public static byte[] createFault(@Nullable final SOAPMessage soapMessage, @Nullable final String faultMessage) {
    ...
    try {
      if (soapMessage != null) {
        final Node element = SoapXPathUtil.safeFindSingleNode(soapMessage.getSOAPHeader(), "//:MessageInfo/:MessageId");
