...
public final class EBMSUtils {
    ...
    try {
      ...
      }
      {
        ...
        }
        {
          ...
          eTo.appendElement (NS_EBMS, "PartyId").appendText (TCConfig.getMEMAS4ToPartyID ());
  ...
  public static SubmissionResult soap2SubmissionResult (final SOAPMessage sSubmissionResult) {
    ...
    try {
      ...
      try {
        final String description = SoapXPathUtil.safeFindSingleNode (messagePropsNode,
  ...
  public static String getMessageId (final SOAPMessage soapMessage) {
    final Node element;
    try {
      element = SoapXPathUtil.safeFindSingleNode (soapMessage.getSOAPHeader (), "//:MessageInfo/:MessageId");
    } catch (final SOAPException e) {
