...
public final class EBMSUtils {
  ...
  static SubmissionMessageProperties inferSubmissionData(final GatewayRoutingMetadata gatewayRoutingMetadata) {
    IR2D2Endpoint endpoint = gatewayRoutingMetadata.getEndpoint();
    ...
    submissionData.toPartyId = TCConfig.getMEMAS4ReceivingPartyID();
    submissionData.fromPartyId = TCConfig.getMEMAS4ToPartyID();
    ...
    try {
      ...
      byte[] certBytes = endpoint.getCertificate().getEncoded();
