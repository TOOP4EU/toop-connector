...
public final class TCConfig {
  ...
  /**
   * The name of the primary system property which points to the <code>toop-connector.properties</code> files
   */
  ...
  /**
   * Reload the configuration file. It checks if the system property {@link #SYSTEM_PROPERTY_TOOP_CONNECTOR_SERVER_PROPERTIES_PATH}
   * is present and if so, tries it first, than {@link #PATH_PRIVATE_TOOP_CONNECTOR_PROPERTIES} is checked and finally
   * the {@link #PATH_TOOP_CONNECTOR_PROPERTIES} path is checked.
   *
   * @return {@link ESuccess}
   */
  @Nonnull
  public static ESuccess reloadConfiguration() {
    final ConfigFileBuilder aCFB = new ConfigFileBuilder()
  ...
  /**
   * @return A debug name to identify an instance. If none is provided, the IP address is used.
   */
  @Nullable
  ...
  /**
   * @return The SMM query URL to GRLC. Should end with a slash. May be <code>null</code> - no default.
   */
  @Nullable
  ...
  /**
   * @return The PEPPOL Directory base URL for R2D2.Should never end with a slash. Example: {@link
  ...
  /**
   * @return The SML URL to be used. Must only contain a value if {@link #isR2D2UseDNS()} returned <code>true</code>.
   */
  @Nonnull
  ...
  /**
   * @return The constant SMP URI to be used. Must only contain a value if {@link #isR2D2UseDNS()} returned
   * <code>false</code>.
   */
  @Nullable
  ...
  /**
   * Get the overall protocol to be used. Depending on that output different other properties might be queried.
   *
  ...
  /**
   * Not used by the message processor any more, because its constant and is bound to the specification. Also the other
   * actions (Notify, deliver...) are also constant and are not put into the configuration. The submit action was moved
   * to another class within the toop-message-processor (see eu.toop.connector.me.EBMSActions)
   */
  @Deprecated
  @Nullable
