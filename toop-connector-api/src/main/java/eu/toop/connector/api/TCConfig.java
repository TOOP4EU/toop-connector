...
public final class TCConfig {
  ...
  /**
   * Not used by the message processor any more, because its constant and is bound
   * to the specification. Also the other actions (Notify, deliver...) are also
   * constant and are not put into the configuration. The submit action was moved
   * to another class within the toop-message-processor (see
   * eu.toop.connector.me.EBMSActions)
   */
  @Deprecated
  @Nullable
